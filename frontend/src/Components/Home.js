...
const Home = () => {
  ...
  return (
    <div className="relative h-[calc(100vh-4rem)] w-full">
      ...
      {/* Loading State */}
      {loading && (
        <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 bg-white text-gray-800 p-4 rounded-lg shadow-lg flex items-center space-x-2">
